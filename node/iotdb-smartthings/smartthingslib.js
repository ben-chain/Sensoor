...
SmartThings.prototype.load_settings = function (filename) {
    ...
    if (!filename) {
        filename = "iotdb-smartthings/smartthings.json";
    }
...
SmartThings.prototype.request_devices = function (device_type) {
    ...
    var devices_url = self.endpointd.base_url + self.endpointd.url + "/" + device_type;
    var devices_paramd = {};
    var devices_headerd = {
...
SmartThings.prototype.device_request = function (deviced, requestd, callback) {
	console.log('smartthingslib: device_request called.');
    var self = this;
    ...
    var devices_url = self.endpointd.base_url + self.endpointd.url + "/" + deviced.type + "/" + deviced.id;
    var devices_headerd = {
        "Authorization": "Bearer " + self.std["access_token"]
    };
